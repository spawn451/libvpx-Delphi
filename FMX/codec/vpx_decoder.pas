...
function vpx_codec_dec_init_ver(ctx: vpx_codec_ctx_t; iface: vpx_codec_iface_t;
  cfg: Pvpx_codec_dec_cfg_t; flags: vpx_codec_flags_t; ver: Integer): vpx_codec_err_t;
  cdecl; external VPX_LIB;
function vpx_codec_peek_stream_info(iface: vpx_codec_iface_t; data: PByte;
  data_sz: Cardinal; si: Pvpx_codec_stream_info_t): vpx_codec_err_t;
  cdecl; external VPX_LIB;
function vpx_codec_get_stream_info(ctx: vpx_codec_ctx_t;
  si: Pvpx_codec_stream_info_t): vpx_codec_err_t;
  cdecl; external VPX_LIB;
function vpx_codec_decode(ctx: vpx_codec_ctx_t; data: PByte; data_sz: Cardinal;
  user_priv: Pointer; deadline: LongInt): vpx_codec_err_t;
  cdecl; external VPX_LIB;
function vpx_codec_get_frame(ctx: vpx_codec_ctx_t;
  iter: vpx_codec_iter_t): Pvpx_image_t;
  cdecl; external VPX_LIB;
function vpx_codec_register_put_frame_cb(ctx: vpx_codec_ctx_t;
  cb: vpx_codec_put_frame_cb_fn_t; user_priv: Pointer): vpx_codec_err_t;
  cdecl; external VPX_LIB;
function vpx_codec_register_put_slice_cb(ctx: vpx_codec_ctx_t;
  cb: vpx_codec_put_slice_cb_fn_t; user_priv: Pointer): vpx_codec_err_t;
  cdecl; external VPX_LIB;
function vpx_codec_set_frame_buffer_functions(ctx: vpx_codec_ctx_t;
  ...
  cb_priv: Pointer): vpx_codec_err_t;
  cdecl; external VPX_LIB;
